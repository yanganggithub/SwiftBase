...
protocol RefreshTableDelegate: class {
    func tableView(tableView: RefreshTable,refreshType: RefreshTable.RefreshType,params:[String:Any])
}

class RefreshTable: UITableView {
    enum RefreshType {
        case Header
        case Footer
    }
